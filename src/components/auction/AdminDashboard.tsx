        ...
        <div className="space-y-3">
          <div className="grid grid-cols-3 gap-4 text-xs">
            <div>
              ...
              <div className="text-lg font-bold text-terminal-green">2.4M GHT</div>
            </div>
            <div>
              <span className="text-muted-foreground">Tokens in Circulation:</span>
              <div className="text-lg font-bold text-terminal-amber">1.8M GHT</div>
            </div>
            <div>
              <span className="text-muted-foreground">Tokens Locked (Bids):</span>
              <div className="text-lg font-bold text-terminal-red">456K GHT</div>
            </div>
          </div>
