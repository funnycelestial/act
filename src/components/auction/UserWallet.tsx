  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <span className="text-xs font-medium">GHANA TOKENS (GHT)</span>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-terminal-green animate-pulse-slow font-bold">2,450 GHT</span>
        </div>
        <Progress value={85} className="h-1" />
        
        <div className="flex items-center justify-between">
          <span className="text-xs">Pending Bids</span>
          <span className="text-xs text-terminal-amber">680 GHT</span>
        </div>
        <Progress value={30} className="h-1" />
        
        <div className="flex items-center justify-between">
          <span className="text-xs">Won (Pending Payment)</span>
          <span className="text-xs text-terminal-red">320 GHT</span>
        </div>
