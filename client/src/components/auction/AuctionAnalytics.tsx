        ...
        <Card className="border-panel-border bg-secondary/20 p-3">
          ...
          <div className="space-y-2 text-xs">
            <div className="flex justify-between">
              ...
              <span className="text-foreground">12,450 GHT</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-terminal-amber">3,200 GHT</span>
            </div>
            <div className="flex justify-between">
          ...
          {[
            ...
            <div key={i} className="space-y-2">
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="text-muted-foreground">{cat.wins}/{cat.total} wins • {cat.spent} GHT</span>
              </div>
              <div className="flex justify-between text-xs mb-1">
